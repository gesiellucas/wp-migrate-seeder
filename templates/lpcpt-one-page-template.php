<section class="flex flex-row  px-20 gap-x-6 pb-10 pt-2">
        <div class="flex-1 p-2 flex flex-col justify-between">
            ...
            <div class="flex flex-col">
                ...
                <button class="w-full text-left text-white text-sm px-3 py-2 hover:bg-slate-600 bg-[color:var(--primary-color)] radius-3 font-['landform-bold'] flex flex-row justify-between place-self-center">
